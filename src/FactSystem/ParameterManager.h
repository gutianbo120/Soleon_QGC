...
private:
    ...
    static const int    _maxInitialLoadRetrySingleParam = 10;//5;    ///< Maximum retries for initial index based load of a single param
    static const int    _maxReadWriteRetry = 10;//5;                 ///< Maximum retries read/write
