...
Item {
    ...
    QGCFileDialog {
        ...
        onAcceptedForSave: {
            ...
            _planFileMode = controller.getFiles(folder, _rgExtensions)
            close()
        }
    ...
    /////////////////////////////////////////////////////////////////////////
    property string folder     :  _appSettings ? _appSettings.missionSavePath : ""          // Due to Qt bug with file url parsing this must be an absolute path
    property var    nameFilters:    _planMasterController.loadNameFilters  // Important: Only name filters with simple wildcarding like *.foo are supported.
    ...
    property var    _planFileMode
    property string _mobileShortPath
    property string _curPlanFileName: ""
    ...
    function _updateMobileShortPath() {
        if (ScreenTools.isMobile) {
            ...
            console.log("_mobileShortPath :"+_mobileShortPath)
        }
    }
        ...
        for (var i=0; i<nameFilters.length; i++) {
            ...
            for (var j=0; j<rgFilters.length; j++) {
                if (!_mobileDlg || (rgFilters[j] !== "*" && rgFilters[j] !== "*.*" )) {
                    ...
                    console.log("_rgExtensions["+j+"]:"+_rgExtensions[j])
                }
            }
        }
    }
    ...
    Item {
        ...
        Item {
            ...
            // SectionHeader {
            //     id:                 selectPlanFileSection
            //     Layout.fillWidth:   true
            //     anchors.left:           parent.left
            //     anchors.right:          parent.right
            //     anchors.top:            rightControls.bottom
            //     anchors.topMargin:      ScreenTools.defaultFontPixelHeight * 0.25
            //     text:               qsTr("Plan File:"+_curPlanFileName.replace(".plan",""))
            //     showSpacer:         false
            //     checked:            false
            // }
            ...
            Rectangle {
                ...
                QGCLabel {
                    ...
                    QGCColoredImage {
                        ...
                        color:                  qgcPal.text
                        visible:                !selectPlanFileSection.checked
                    }
                }
               MouseArea  {
                    anchors.fill: parent
                    onClicked: {
                        selectPlanFileSection.checked = !selectPlanFileSection.checked
                    }
                }
            }
            ...
            // select Plan File
            Item {
               id: selectPlanFileRoot
               anchors.left:           parent.left
               anchors.right:          parent.right
               anchors.top:            selectPlanFileSection.bottom//planFileTitle.bottom
               anchors.topMargin:      ScreenTools.defaultFontPixelHeight * 0.25
               height: visible?parent.height*0.35:0
               visible: selectPlanFileSection.checked
               ...
               QGCListView {
                   ...
                   delegate:        FileButton {
                       id:          fileButton
                       width:       planFileListView.width
                       text:        modelData
                       onClicked: {
                           //highlight = true
                           _planMasterController.loadFromFile(controller.fullyQualifiedFilename(folder, modelData))
                           _planMasterController.fitViewportToItems()
                           _missionController.setCurrentPlanViewSeqNum(0, true)
                           _curPlanFileName = modelData
                       }
                       onHamburgerClicked: {
                           //highlight = true
            ...
            Item {
                ...
                anchors.left:           parent.left
                anchors.right:          parent.right
                anchors.top:            selectPlanFileRoot.bottom//rightControls.bottom
                anchors.topMargin:      ScreenTools.defaultFontPixelHeight * 0.25
                anchors.bottom:         parent.bottom
    ...
    Component {
        ...
        ColumnLayout {
            ...
            QGCLabel {
                ...
                text:               globals.activeVehicle ? qsTr("unsaved changes."):qsTr("unsaved changes.")
            ...
            GridLayout {
                ...
                rowSpacing:         _margin
                Layout.fillWidth:   true
                visible:            createSection.visible && createSection.checked
