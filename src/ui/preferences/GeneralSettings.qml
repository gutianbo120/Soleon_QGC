                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            GridLayout {
                                ...
                                QGCLabel {
                                    id:         videoTransmitIPLabel
                                    text:       qsTr("UDP forwarding IP")
                                    visible:    videoSource.fact ? ((videoSource.fact.enumIndex === 0) ? false : true) : false
                                }

                                FactTextField {
                                    id:                     videoTransmitIPTextField
                                    Layout.preferredWidth:  _comboFieldWidth
                                    fact:                   _videoSettings.transmitIP
                                    visible:                videoSource.fact ? ((videoSource.fact.enumIndex === 0) ? false : true) : false
                                    enabled:                true
//                                    onTextChanged:{
//                                        _videoSettings.transmitIP.value  = videoTransmitIPTextField.text
//                                    }
                                }

                                QGCLabel {
                                    id:         videoTransmitPortLabel
                                    text:       qsTr("UDP forwarding Port")
                                    visible:    videoSource.fact ? ((videoSource.fact.enumIndex === 0) ? false : true) : false
                                }

                                FactTextField {
                                    id:                     videoTransmitPortTextField
                                    Layout.preferredWidth:  _comboFieldWidth
                                    fact:                   _videoSettings.transmitPort
                                    visible:                videoSource.fact ? ((videoSource.fact.enumIndex === 0) ? false : true) : false
                                    enabled:                true
//                                    onTextChanged:{
//                                        _videoSettings.transmitPort.value  = videoTransmitPortTextField.text
//                                    }
                                }
